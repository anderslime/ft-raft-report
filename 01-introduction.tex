...
The fundamental problem behind this is that you cannot rely on the individual processes to be reliable and thus solely store the value. This boils down to a well-known problem - The Two Generals Problem.
